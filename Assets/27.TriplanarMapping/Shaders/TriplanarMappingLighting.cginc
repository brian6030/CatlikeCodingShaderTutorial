...
#include "TriplanarMappingLightingInput.cginc"
...
FragmentOutput MyFragmentProgram (Interpolators i) 
{
	...
	float4 color = UNITY_BRDF_PBS(
		albedo, specularTint, oneMinusReflectivity, surface.smoothness, i.normal, viewDir, CreateLight(i), CreateIndirectLight(i, viewDir, surface));

Shader "Custom/TriplanarMapping" {
	...
	SubShader {
		...
		Pass {
			...
			#include "TriplanarMappingLighting.cginc"
		...
		Pass {
			...
			#include "TriplanarMappingShadows.cginc"
		...
		Pass {
			...
			//#include "MyTriplanarMapping.cginc"
			#include "MyTriplanarLightMapping.cginc"

			ENDCG
		}

	}
	CustomEditor "TriplanarMappingShaderGUI"
}